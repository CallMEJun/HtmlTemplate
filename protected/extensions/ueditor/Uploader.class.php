...
class Uploader
{
    ...
    private function upBase64()
    {
        ...
        $this->upload(null, $img, $this->get_ext_mime($this->fileType));
    }
    ...
    private function upload($path, $file, $mime) {
        $accessKey = Yii::app()->params['partner']['oss']['id'];
        $secretKey = Yii::app()->params['partner']['oss']['key'];
        $bucket = Yii::app()->params['partner']['oss']['bucket'];
        $domain = Yii::app()->params['partner']['oss']['domain'];
        $auth = new upload($accessKey, $secretKey);
